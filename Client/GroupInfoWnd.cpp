...
GroupInfoWnd::GroupInfoWnd(QWidget* p /*= nullptr*/) : QWidget(p)
{
    ...
    m_groupName2 = new EditLabel(m_centerWnd);
    ...
    m_groupNotice2 = new EditLabel(m_centerWnd);
    ...
    m_groupRemarks2 = new EditLabel(m_centerWnd);
    ...
    m_groupRoleName2 = new EditLabel(m_centerWnd);
    ...
    m_showGroupFriendsRoleNameBtn = new SelfSwitchButton();
    ...
    m_MsgFreeBtn = new SelfSwitchButton();
    ...
    m_topWndBtn = new SelfSwitchButton();
    ...
    m_save2AddrBookBtn = new SelfSwitchButton();
...
void GroupInfoWnd::addGroupFriendItem(int64_t ownerId, QString nickName)
{
    ...
    GroupFriendsItemWnd* itemWnd = new GroupFriendsItemWnd();
