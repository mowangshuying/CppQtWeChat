...
class NetClientUtils : public QObject
{
  ...
  public:
    ...
    void regMsgCall(QString cmd, NetEventCall call);
    bool transfer(neb::CJsonObject& msg);
    bool request(const std::string& cmd, neb::CJsonObject& json);
    bool request(const std::string& cmd, neb::CJsonObject& json, NetEventCall call);
