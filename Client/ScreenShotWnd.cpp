...
ScreenShotWnd::ScreenShotWnd(QWidget* p /*= nullptr*/) : QWidget(p)
{
    ...
    m_toolBarWnd = new ScreenShotToolBarWnd(this);
    m_toolBarWnd->hide();
...
void ScreenShotWnd::slotCopyScreenShot()
{
...
void ScreenShotWnd::slotSaveScreenShot()
{
...
void ScreenShotWnd::slotExitSccreenShot()
{
    m_toolBarWnd->close();
    this->close();
}

void ScreenShotWnd::showEvent(QShowEvent* showEvent)
{
...
void ScreenShotWnd::paintEvent(QPaintEvent* event)
{
    if (m_isPainting)
    {
        return;
...
void ScreenShotWnd::contextMenuEvent(QContextMenuEvent*)
{
}

void ScreenShotWnd::keyPressEvent(QKeyEvent* e)
{
    /// Esc 键退出截图;
